                ...
                >
                  ...
                  <div className={`w-full lg:w-2/5 relative overflow-hidden`}>
                    <img
                      src={award.image}
                      alt={award.title}
                      className="w-full h-full min-h-[300px] sm:min-h-[350px] lg:min-h-[400px] object-cover transform group-hover:scale-105 transition-transform duration-700"
                      onError={(e) => {
                  ...
                  {/* Award Content */}
                  <div className={`w-full lg:w-3/5 flex flex-col justify-center p-8 sm:p-12 lg:p-16 ${isLeft ? 'lg:pl-12' : 'lg:pr-12'}`}>
                    {/* Award Number Badge */}
